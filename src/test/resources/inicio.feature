...
Característica: hacer uso de las distintas secciones y comprar informacion
  ...
  Escenario: selecciona la opcion de servicios
  ...
  Escenario: selecciona la opcion de industrias
  ...
  Escenario: selecciona la opcion de Formacion
  ...
  Escenario: selecciona la opcion de Comunidad
  ...
  Escenario: selecciona la opcion de Empleos
  ...
  Escenario: selecciona la opcion de Nosotros
  ...
  Escenario: selecciona la opcion de Contactenos
